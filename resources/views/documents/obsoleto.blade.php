<x-layouts.vigia title="Obsoleto">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">Regulaciones vencidas y versiones anteriores del módulo de Procesos</p>
        </div>
    ...
    <div class="mt-8">
        <div class="flex items-center gap-2 mb-3">
            ...
            <span class="text-xs text-gray-400 font-normal">(versión actual con fecha de vigencia expirada)</span>
            <span class="ml-auto text-xs font-medium text-gray-500">{{ $expiredRegulations->count() }} documentos</span>
        </div>
    ...
    <div class="mt-10">
        <div class="flex items-center gap-2 mb-3">
            ...
            <span class="text-xs text-gray-400 font-normal">(archivos reemplazados del histórico de versiones)</span>
            <span class="ml-auto text-xs font-medium text-gray-500">{{ $oldVersions->count() }} archivos</span>
        </div>
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b border-gray-100 bg-gray-50">
                            ...
                            <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wide">Subido</th>
                            <th class="px-4 py-3"></th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-100">
