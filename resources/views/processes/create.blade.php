<x-layouts.vigia title="Nuevo Proceso">
    ...
    <x-slot name="breadcrumb">
        ...
        @if($selectedCompanyId)
            ...
            <span class="mx-2 text-gray-400">/</span>
        @endif
        <span class="text-gray-700 font-medium">Nuevo Proceso</span>
    </x-slot>
    ...
    @php
        ...
        $blockFields = [
            1 => ['company_id', 'process_type_id', 'document_type', 'nombre', 'codigo', 'quien_elabora', 'quien_aprueba', 'fecha_vigencia'],
    ...
    >
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between mb-1">
                <h1 class="text-2xl font-semibold text-[#1A428A]">Nuevo Proceso</h1>
            ...
            <div class="flex-1 min-w-0">
                ...
                >
                            ...
                            <div class="p-6 space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        x-model="form.problema_resuelve"
                                        rows="4"
                                        placeholder="¿Qué falla hoy? ¿Qué se pierde o confunde?"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        x-model="form.resultado_esperado"
                                        rows="4"
                                        placeholder="¿Cómo se ve el éxito cuando el procedimiento funciona bien?"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        name="areas_aplica"
                                        x-model="form.areas_aplica"
                                        rows="4"
                                        placeholder="Ej: Compras, Finanzas, toda planta que genere órdenes"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        name="fuera_alcance"
                                        x-model="form.fuera_alcance"
                                        rows="4"
                                        placeholder="Ej: No aplica a compras menores a $500 MXN"
                        ...
                        <div class="bg-white border rounded-xl shadow-sm overflow-hidden">
                            ...
                            <div class="p-6 space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        name="indicador_proceso"
                                        x-model="form.indicador_proceso"
                                        rows="4"
                                        placeholder="¿Qué mides para saber que se ejecuta bien? Ej: % de pasos completados"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        name="indicador_resultado"
                                        x-model="form.indicador_resultado"
                                        rows="4"
                                        placeholder="¿Qué mides para saber que el objetivo se logró?"
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        x-model="form.frecuencia_medicion"
                                        placeholder="Ej: Mensual — Jefe de Compras"
                        ...
                        <div class="bg-white border rounded-xl shadow-sm overflow-hidden">
                            ...
                            <div class="p-6 space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        name="que_detona"
                                        x-model="form.que_detona"
                                        rows="4"
                                        placeholder="Ej: Solicitud de alta recibida por correo o sistema"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        x-model="form.lista_actividades"
                                        rows="6"
                                        placeholder="Una por línea numerada. Indica quién ejecuta + qué hace + con qué herramienta"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        name="areas_ejecutan"
                                        x-model="form.areas_ejecutan"
                                        rows="4"
                                        placeholder="Ej: Compras (1,2,5), Finanzas (3), TI (4)"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        name="decisiones_control"
                                        x-model="form.decisiones_control"
                                        rows="4"
                                        placeholder="Ej: Si documentos incompletos → regresar. Si pasan → continuar."
                                ...
                                <div>
                                    ...
                                    <textarea
                                        name="documentos_usados"
                                        x-model="form.documentos_usados"
                                        rows="4"
                                        placeholder="Ej: F-COM-001, ERP módulo Compras, correo electrónico"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        name="resultado_entregable"
                                        x-model="form.resultado_entregable"
                                        rows="4"
                                        placeholder="Ej: Proveedor activo en ERP con expediente completo"
                        ...
                        <div class="bg-white border rounded-xl shadow-sm overflow-hidden">
                            ...
                            <div class="p-6 space-y-5">
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        name="areas_roles_mapa"
                                        x-model="form.areas_roles_mapa"
                                        placeholder="Ej: Solicitante, Compras, Finanzas, TI, Dirección"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        x-model="form.procedimientos_relacionados"
                                        rows="4"
                                        placeholder="Formato: CÓDIGO | Nombre (uno por línea)"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        x-model="form.proveedores_clientes"
                                        rows="4"
                                        placeholder="Ej: El proveedor envía documentos. El cliente recibe notificación."
                        ...
                        <div class="bg-white border rounded-xl shadow-sm overflow-hidden">
                            ...
                            <div class="p-6 space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        name="terminos_abreviaturas"
                                        x-model="form.terminos_abreviaturas"
                                        rows="4"
                                        placeholder="Ej: OC = Orden de Compra; SAT = Servicio de Administración Tributaria"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        name="riesgos_errores"
                                        x-model="form.riesgos_errores"
                                        rows="4"
                                        placeholder="Ej: Se omite la validación fiscal y se pagan facturas inválidas."
                                ...
                                <div>
                                    ...
                                    <textarea
                                        name="requerimientos_normativos"
                                        x-model="form.requerimientos_normativos"
                                        rows="4"
                                        placeholder="Ej: ISO 9001:2015 cláusula 8.4 — Control de procesos externos"
                    ...
                    <div class="mt-6 flex items-center justify-between">
                        ...
                        {{-- Izquierda: Cancelar (bloque 1) o Anterior --}}
                        ...
                        {{-- Derecha: un solo botón que cambia según bloque --}}
    ...
    <script>
    function wizardApp(preselectedCompanyId, hasGroupScope) {
        return {
            currentBlock: 1,
            ...
            form: {
                ...
                areas_roles_mapa:             '',
                procedimientos_relacionados:  '',
                proveedores_clientes:         '',
                terminos_abreviaturas:        '',
                riesgos_errores:              '',
                requerimientos_normativos:    '',
            },

            errors: {},

            // Map block number → array of required field names
            blockFieldMap: {
                1: [],  // filled in init()
                2: ['problema_resuelve', 'resultado_esperado', 'areas_aplica', 'fuera_alcance'],
                3: ['indicador_proceso', 'indicador_resultado', 'meta_valor', 'frecuencia_medicion'],
            ...
            blockColor(b) {
                return this.blockColors[b] || '#1A428A';
            },
            ...
            validateBlock(blockNum) {
                const fields = this.blockFieldMap[blockNum] || [];
                let valid = true;
            ...
            goToBlock(b) {
                if (!this.canNavigateTo(b)) return;
                this.currentBlock = b;
                this.$nextTick(() => window.scrollTo({ top: 0, behavior: 'smooth' }));
            },
            ...
            submitWizard() {
                let firstInvalid = 0;
                for (let b = 1; b <= 6; b++) {
                    if (!this.validateBlock(b) && firstInvalid === 0) {
                        firstInvalid = b;
                    }
                }
                if (firstInvalid > 0) {
